...
prob = Problem('treegenerator')

# copy from the manual cases in input_manual
prob.manualCases('input_manual')

# parse the test generator rules defined in the file "treegenerator.rules",
# and generate tests via program using the rules
prob.programCases('treegenerator.rules', funcs)
...
prob.packCases('treegenerator.groups')
