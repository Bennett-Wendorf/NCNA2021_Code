...
prob = Problem('lonerook')

# copy from the manual cases in input_manual
prob.manualCases('input_manual')
prob.manualCases('spiral')

# parse the test generator rules defined in the file "lonerook.rules",
# and generate tests via program using the rules
prob.programCases('lonerook.rules', funcs)
...
prob.packCases('lonerook.groups')
