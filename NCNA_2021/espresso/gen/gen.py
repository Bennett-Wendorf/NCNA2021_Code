...
prob = Problem('espresso')

# copy from the manual cases in input_manual
prob.manualCases('input_manual')

# parse the test generator rules defined in the file "expresso.rules",
# and generate tests via program using the rules
prob.programCases('espresso.rules', funcs)
...
prob.packCases('espresso.groups')
