...
prob = Problem('parkinglot')

# copy from the manual cases in input_manual
prob.manualCases('input_manual')

# parse the test generator rules defined in the file "parkinglot.rules",
# and generate tests via program using the rules
prob.programCases('parkinglot.rules', funcs)
...
prob.packCases('parkinglot.groups')
