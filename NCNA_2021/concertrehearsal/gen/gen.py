...
prob = Problem('concertrehearsal')

# copy from the manual cases in input_manual
prob.manualCases('input_manual')

# parse the test generator rules defined in the file "concertrehearsal.rules",
# and generate tests via program using the rules
prob.programCases('concertrehearsal.rules', funcs)
...
prob.packCases('concertrehearsal.groups')
