...
prob = Problem('landequality')

# copy from the manual cases in input_manual
prob.manualCases('input_manual')

# parse the test generator rules defined in the file "landequality.rules",
# and generate tests via program using the rules
prob.programCases('landequality.rules', funcs)
...
prob.packCases('landequality.groups')
