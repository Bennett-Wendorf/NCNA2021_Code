...
prob = Problem('bracketpairing')

# copy from the manual cases in input_manual
prob.manualCases('input_manual')

# parse the test generator rules defined in the file "bracketpairing.rules",
# and generate tests via program using the rules
prob.programCases('bracketpairing.rules', funcs)
...
prob.packCases('bracketpairing.groups')
