...
prob = Problem('streamlag')

# copy from the manual cases in input_manual
prob.manualCases('input_manual')

# parse the test generator rules defined in the file "streamlag.rules",
# and generate tests via program using the rules
prob.programCases('streamlag.rules', funcs)
...
prob.packCases('streamlag.groups')
