...
prob = Problem('codeguessing')

# copy from the manual cases in input_manual
prob.manualCases('input_manual')

# parse the test generator rules defined in the file "codeguessing.rules",
# and generate tests via program using the rules
#prob.programCases('codeguessing.rules', funcs)
...
prob.packCases('codeguessing.groups')
