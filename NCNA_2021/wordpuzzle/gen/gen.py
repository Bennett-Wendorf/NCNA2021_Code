...
prob = Problem('wordpuzzle')

# copy from the manual cases in input_manual
prob.manualCases('input_manual')

# parse the test generator rules defined in the file "wordpuzzle.rules",
# and generate tests via program using the rules
prob.programCases('wordpuzzle.rules', funcs)
...
prob.packCases('wordpuzzle.groups')
